...
export function AddSarprasFormModal({ isOpen, onClose, setRefreshSignal }) {
  ...
  const addBookHandler = async () => {
    try {
      ...
      const res = await fetcher.post("/sarpras", book);
  ...
  return (
    <>
      ...
      >
        ...
        <ModalContent>
          <ModalHeader>Tambah Data Sarana dan Prasarana</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <Stack
              spacing={4}
            ...
            >
              ...
              <Stack flex={3} as="form" spacing={4} ref={formRef}>
                ...
                <DecimalNumberInput title="Jumlah" name="jumlah"></DecimalNumberInput>
              </Stack>
            </Stack>
          </ModalBody>
