...
export function EditStrukturFormModal({
  initialBook,
  isOpen,
  onClose,
  setRefreshSignal,
  ...
  const editBookHandler = async () => {
    try {
      ...
      const res = await fetcher.put("/struktur/" + initialBook._id, book);
  ...
  return (
    <>
      ...
      >
        ...
        <ModalContent>
          <ModalHeader>Edit Data Struktur Kepengurusan</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <Stack
              spacing={4}
