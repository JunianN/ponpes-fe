...
export function AddStrukturFormModal({ isOpen, onClose, setRefreshSignal }) {
    ...
    try {
      ...
      if (
        ...
        toast({
          title: "Error",
          description:
            "Nama, Jenis Kelamin, dan jabatan harus diisi",
          status: "error",
          duration: 5000,
          isClosable: true,
        });
      ...
      const res = await fetcher.post("/struktur", book);
  ...
  return (
    <>
      ...
      >
        ...
        <ModalContent>
          <ModalHeader>Tambah Data Struktur Kepengurusan</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <Stack
              spacing={4}
            ...
            >
              ...
              <Stack flex={3} as="form" spacing={4} ref={formRef}>
                ...
                <TextInput title="Jabatan" name="jabatan" />
              </Stack>
            </Stack>
          </ModalBody>
